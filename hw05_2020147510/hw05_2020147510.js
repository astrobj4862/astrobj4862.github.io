...
function render() {
    ...
    // Model transformation matrix (no use this hw)
    // mat4.rotateX(modelMatrix, modelMatrix, glMatrix.toRadian(deltaTime * 90));
